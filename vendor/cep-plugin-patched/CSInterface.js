...
CSInterface.prototype.evalScript = function (script, callback) {
  ...
  if (typeof __adobe_cep__ !== "undefined") {
    // __adobe_cep__.evalScript is asynchronous: the result is delivered to the
    // callback passed as the second argument. Its synchronous return value is
    // always undefined — do NOT use it as the result.
